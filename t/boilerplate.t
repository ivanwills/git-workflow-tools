...
module_boilerplate_ok('bin/git-package');
module_boilerplate_ok('bin/git-pom');
module_boilerplate_ok('bin/git-popb');
module_boilerplate_ok('bin/git-pushb');
module_boilerplate_ok('bin/git-recent');
module_boilerplate_ok('bin/git-remote-delete');
module_boilerplate_ok('bin/git-reset-to');
module_boilerplate_ok('bin/git-search');
module_boilerplate_ok('bin/git-tag-grep');
module_boilerplate_ok('bin/git-touch');
module_boilerplate_ok('bin/git-up-to-date');
module_boilerplate_ok('bin/git-watch');
module_boilerplate_ok('lib/App/Git/Workflow.pm');
module_boilerplate_ok('lib/App/Git/Workflow/Brs.pm');
...
module_boilerplate_ok('lib/App/Git/Workflow/Command/Brs.pm');
module_boilerplate_ok('lib/App/Git/Workflow/Command/Changes.pm');
...
module_boilerplate_ok('lib/App/Git/Workflow/Command/Popb.pm');
module_boilerplate_ok('lib/App/Git/Workflow/Command/Pushb.pm');
module_boilerplate_ok('lib/App/Git/Workflow/Command/Recent.pm');
module_boilerplate_ok('lib/App/Git/Workflow/Command/RemoteDelete.pm');
module_boilerplate_ok('lib/App/Git/Workflow/Command/ResetTo.pm');
...
module_boilerplate_ok('lib/App/Git/Workflow/Command/Touch.pm');
